        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.evaluateJavascript(
                        ...
                        "function load924(){if(!document.getElementById('pitlane-vehicles-924-v038')){var p=document.createElement('script');p.id='pitlane-vehicles-924-v038';p.src='https://appassets.androidplatform.net/assets/vehicle_catalogue_924_v038.js';document.body.appendChild(p);}}" +
